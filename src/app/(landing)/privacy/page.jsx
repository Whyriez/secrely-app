    ...
    <div className="font-inter text-richGray-800 overflow-hidden min-h-screen">
      <div className="page-wrapper overflow-hidden min-h-screen">
        ...
        <section className="pb-20 px-6 md:px-12 lg:px-24 relative">
          <div className="max-w-4xl mx-auto">
            <div className="glass-card rounded-3xl p-8 mb-8 scroll-reveal">
              ...
              <div className="accordion-content mt-4 text-richGray-700 leading-relaxed">
                ...
                <div className="pl-4">
                  ...
                  <ul className="list-disc pl-5 space-y-2">
                    <li>
                      How you interact with the app (features used, time spent)
                    </li>
                    <li>Error reports</li>
            ...
            >
              ...
              <div className="accordion-content mt-4 text-richGray-700 leading-relaxed">
                ...
                <div className="pl-4 mb-4">
                  ...
                  <ul className="list-disc pl-5 space-y-2">
                    <li>
                      Detecting and preventing abuse or violations of our terms
                    </li>
            ...
            >
              ...
              <div className="accordion-content mt-4 text-richGray-700 leading-relaxed">
                <p className="mb-4">
                  We partner with trusted third parties to help provide and
                  improve our service. Here are the types of third parties we
                  work with:
                </p>
                ...
                <div className="pl-4 mb-4">
                  ...
                  <ul className="list-disc pl-5 space-y-2">
                    <li>
                      <span className="font-medium">Firebase:</span> For secure
                      data storage and authentication
                    </li>
                    <li>
                      <span className="font-medium">AWS:</span> For server
                ...
                <div className="pl-4 mb-4">
                  ...
                  <ul className="list-disc pl-5 space-y-2">
                    ...
                    <li>
                      <span className="font-medium">Crashlytics:</span> For
                ...
                <div className="pl-4">
                  ...
                  <ul className="list-disc pl-5 space-y-2">
                    <li>
                      <span className="font-medium">reCAPTCHA:</span> To prevent
                      spam and abuse
                    </li>
                    <li>
                ...
                <p className="mt-4">
                  All third parties we work with are bound by strict data
                  protection agreements and are carefully selected to ensure
                  they maintain high privacy standards.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="accordion-content mt-4 text-richGray-700 leading-relaxed">
                <p className="mb-4">
                  At Secrely, we believe you should have control over your data.
                  Here are the rights and options available to you:
                </p>
                ...
                <div className="pl-4 mb-4">
                  ...
                  <p className="mb-2">
                    ...
                    about you. To do this:
                  </p>
                  <ul className="list-disc pl-5 space-y-2">
                    <li>Go to Settings &gt; Privacy &gt; Download My Data</li>
                    <li>
                      We'll provide your data in a machine-readable format
                      within 30 days
                    </li>
                  </ul>
                </div>
                ...
                <div className="pl-4 mb-4">
                  ...
                  <p className="mb-2">
                    You can choose not to share usage data:
                  </p>
                  <ul className="list-disc pl-5 space-y-2">
                ...
                <div className="pl-4">
                  ...
                  <p className="mb-2">
                    ...
                    under local laws (such as GDPR or CCPA):
                  </p>
                  <ul className="list-disc pl-5 space-y-2">
